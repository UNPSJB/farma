...
class Medicamento(models.Model):
    ...
    precioDeVenta = models.FloatField("Precio de venta", validators=[MinValueValidator(0.0), MaxValueValidator(9999)], help_text="Este es el precio de venta del medicamento")

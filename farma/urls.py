...
urlpatterns = [
    ...
    url(r'^farmacias/add/$', oviews.farmacias_add, name="farmacia_add"),
    url(r'^farmacias/delete/(\d+)/$', oviews.farmacias_delete, name="farmacia_delete"),
    url(r'^farmacias/modify/$', oviews.farmacias, name="farmacia_modify"),
    url(r'^clinicas/$',oviews.clinicas, name="clinicas"),
    url(r'^clinicas/add/$', oviews.clinicas, name="clinica_add"),
    url(r'^clinicas/delete/$', oviews.clinicas, name="clinica_delete"),
    url(r'^clinicas/modify/$', oviews.clinicas, name="clinica_modify"),
    url(r'^laboratorios/$',oviews.laboratorios, name="laboratorios"),
    url(r'^laboratorios/add/$', oviews.laboratorios, name="laboratorio_add"),
    url(r'^laboratorios/delete/$', oviews.laboratorios, name="laboratorio_delete"),
    url(r'^laboratorios/modify/$', oviews.laboratorios, name="laboratorio_modify"),
